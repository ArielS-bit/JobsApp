...
namespace JobsApp.Services
{
    class JobsAPIProxy
    {
        ...
        private const string DEV_ANDROID_EMULATOR_URL = "http://10.0.2.2:27556"; //API url when using emulator on android
        private const string DEV_ANDROID_PHYSICAL_URL = "http://192.168.1.14:27556"; //API url when using physucal device on android
        private const string DEV_WINDOWS_URL = "https://localhost:44340"; //API url when using windoes on development
        ...
        private const string DEV_WINDOWS_PHOTOS_URL = "https://localhost:44340/Images"; //API url when using windoes on development
