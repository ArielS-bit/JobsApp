...
namespace JobsApp.Services
{
    class JobsAPIProxy
    {
        ...
        private const string DEV_ANDROID_PHYSICAL_URL = "http://192.168.1.14:27556/iJobAPI"; //API url when using physucal device on android
        private const string DEV_WINDOWS_URL = "https://localhost:44340/iJobAPI"; //API url when using windoes on development
